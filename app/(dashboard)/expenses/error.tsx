  ...
  return (
    <div className="flex items-center justify-center min-h-[40vh]">
      <div className="text-center max-w-md p-8">
        <h1 className="text-headline-md font-headline-md text-[#D4AF37] mb-4">Expenses Error</h1>
        <p className="font-body-md text-[#46464d] mb-6">Failed to load expenses. Please try again.</p>
        <button
          onClick={() => reset()}
